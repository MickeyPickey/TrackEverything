...
local LastTrackedOnRes = TE.Init("Service.LastTrackedOnRes", "AceTimer-3.0", "AceConsole-3.0", "AceEvent-3.0")
local SpellSwitcher = TE.Init("Service.SpellSwitcher", "AceTimer-3.0", "AceConsole-3.0", "AceEvent-3.0")
